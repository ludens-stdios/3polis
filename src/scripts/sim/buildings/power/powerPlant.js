...
export class PowerPlant extends Building {
  ...
  toHTML() {
    ...
    html += `
      <div class="info-heading">Potencia</div>
      <span class="info-label">Capacidad (kW)</span>
      <span class="info-value">${this.powerCapacity}</span>
      <br>
      <span class="info-label">Consumida (kW)</span>
      <span class="info-value">${this.powerConsumed}</span>
      <br>
      <span class="info-label">Disponible (kW)</span>
